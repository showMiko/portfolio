...
const Item = styled.div`
  ...
  transform: ${(props) =>
    `rotate(${props.rotate}deg) translateY(-10vw) rotate(${-props.rotate}deg)`};
  img {
    max-width: 100%;
    max-height: 100%;
  }
...
const Carousel_Circle = () => {
  const [items, setItems] = useState([    { id: 1, imgUrl: C_Sharp},    { id: 2, imgUrl: Clang },    { id: 3, imgUrl: HTMLpic },    { id: 4, imgUrl: css },    { id: 5, imgUrl: js },    { id: 6, imgUrl: MERN },    { id: 7, imgUrl: java },    { id: 8, imgUrl: Unity },    { id: 9, imgUrl: Python },  ]);
        ...
        <Item
          ...
          style={{
            transform: `rotate(${
              ...
              (360 / items.length)
            }deg) translateY(-50%) rotate(${
              -((index - current + items.length) % items.length) *
              (360 / items.length)
            }deg)`,
            marginLeft: `calc(-10vw - ${index * 5}vw)`
          }}
        >
...
export default Carousel_Circle;
